...
var ALL_STRUCTS = barrister2.StructMap{}
var ALL_ENUMS = barrister2.EnumMap{}
...
func (s *BarristerServer) handleSingleRequest(requestJson map[string]interface{}) map[string]interface{} {
	...
	for i, paramValue := range params {
		...
		if err := barrister2.ValidateType(paramValue, paramType, ALL_STRUCTS, ALL_ENUMS, false); err != nil {
	...
	if err != nil {
		if rpcErr, ok := err.(*barrister2.RPCError); ok {
	...
	if returnType != nil {
		...
		if err := barrister2.ValidateType(resultInterface, returnType, ALL_STRUCTS, ALL_ENUMS, returnOptional); err != nil {
