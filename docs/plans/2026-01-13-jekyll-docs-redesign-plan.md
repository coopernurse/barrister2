...
Modernize the PulseRPC documentation site by implementing the "Just the Docs" Jekyll theme with custom purple/indigo branding, improved typography, sidebar navigation, and a redesigned homepage.
