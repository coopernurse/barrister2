...
func generateServerPy(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, interfaceMap map[string]*parser.Interface, namespaceMap map[string]*NamespaceTypes, baseDir string, outputDir string) string {
	var sb strings.Builder
...
func generateClientPy(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, interfaceMap map[string]*parser.Interface, namespaceMap map[string]*NamespaceTypes, baseDir string, outputDir string) string {
	var sb strings.Builder
...
func generateTestServerPy(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, interfaceMap map[string]*parser.Interface, namespaceMap map[string]*NamespaceTypes, baseDir string, outputDir string) string {
	var sb strings.Builder
...
func generateTestClientPy(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, interfaceMap map[string]*parser.Interface, namespaceMap map[string]*NamespaceTypes, baseDir string, outputDir string) string {
	var sb strings.Builder
