...
func (p *PythonClientServer) Generate(idl *parser.IDL, fs *flag.FlagSet) error {
	...
	if generateTestServer {
		...
		testServerCode := generateTestServerPy(idl, structMap, enumMap, interfaceMap)
		...
		testClientCode := generateTestClientPy(idl, structMap, enumMap, interfaceMap)
...
func generateTestServerPy(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, interfaceMap map[string]*parser.Interface) string {
	var sb strings.Builder
...
func generateTestClientPy(idl *parser.IDL, structMap map[string]*parser.Struct, enumMap map[string]*parser.Enum, interfaceMap map[string]*parser.Interface) string {
	var sb strings.Builder
